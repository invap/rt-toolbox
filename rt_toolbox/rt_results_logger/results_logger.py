...
class ResultsLogger(threading.Thread):
    ...
    def run(self):
        ...
        while not control["should_stop"]():
            ...
            # a ResultsLoggerError is raised, which is not handled in this method and thus should be handled by the caller of the 
            # run() method; if an error occurs during the sending of the ack to RabbitMQ, a ResultsLoggerError is raised, which is 
