...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog = "Example: python -m rt_analysis_stats.rt_analysis_stats_sh /path/to/file --host=https://myrabbitmq.org.ar --port=5672 --user=my_user --password=my_password --log_file=output.log --log_level=event --timeout=120"
    )
    ...
    parser.add_argument('--exchange', type=str, default='my_log_exchange', help='Name of the results exchange at the RabbitMQ logging server.')
